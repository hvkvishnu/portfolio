...
export const AccoladesDetails: ResumeData[] = [
  {
    title: "Hackathons",
    content: [
      {
  ...
  },
  {
    ...
    content: [
      {
        details: [
          "Recognized with the <a class='link'>Above & Beyond Award</a> in 2024 for the outstanding contributions to the project.",
          "Recognized with the <a class='link'>Spot Award in Jun 2023</a> for creating a significant impact in the project.",
          "Recognized with the <a class='link'>Spot Award in Jan 2023</a> for creating a significant impact in the project.",
          "Recognized with the <a class='link'>Spot Award in Aug 2022</a> for creating a significant impact in the project.",
        ],
      },
    ],
  },
